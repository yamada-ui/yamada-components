...
const importTSESConfig = {
  name: "@yamada-components/import/base",
...
const eslintTSESConfig = {
  name: "@yamada-components/eslint/base",
  files: sourceFilePaths.all,
  rules: {
...
const typescriptTSESConfigArray = [
  {
    name: "@yamada-components/typescript/base",
    files: sourceFilePaths.all,
    plugins: {
  ...
  // These rules existed in the `.eslintrc`.
  {
    name: "@yamada-components/typescript/disabled-in-js",
...
const reactTSESConfig = {
  name: "@yamada-components/react/base",
  files: sourceFilePaths.all,
  plugins: {
    react: pluginReact,
  },
...
const reactHooksTSESConfig = {
  name: "@yamada-components/react-hooks/base",
  files: sourceFilePaths.all,
  plugins: {
...
const nextTSESConfig = {
  name: "@yamada-components/next/base",
  files: sourceFilePaths.all,
  plugins: {
...
const jsxA11yTSESConfig = {
  name: "@yamada-components/jsx-a11y/base",
  files: sourceFilePaths.all,
  plugins: {
...
const vitestTSESConfig = {
  name: "@yamada-components/vitest/base",
...
const testingLibraryTSESConfig = {
  name: "@yamada-components/testing-library/react/base",
  files: ["**/*.test.ts", "**/*.test.tsx"],
  plugins: {
...
const prettierTSESConfig = {
  name: "@yamada-components/prettier/base",
  files: sourceFilePaths.all,
  plugins: {
    react: pluginReact,
  },
