...
export const ComponentPreview:FC<{path: string; code: string;}> = ({path, code}) => {
    ...
    <LiveProvider code={code} scope={{ ...YamadaUI, ...React }} enableTypeScript noInline transformCode={transformCode} >
        <Box>
            <LiveEditor />
            <LivePreview />
        </Box>
